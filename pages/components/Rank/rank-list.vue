<template>
	<view class="rank_data">
		<scroll-view
			...
			:lower-threshold="tolower"
			@scroll="upScroll"
			@scrolltolower="getNextData"
			...
			<block v-for="(item, index) in gameData" :key="index">
				<view class="rank_item">
					<view class="item_ft">
						...
						<view class="center"><image :src="item.img_url" mode=""></image></view>
						<view class="right">
					...
					<view class="item_bd"><view class="info">详情</view></view>
				</view>
			</block>
